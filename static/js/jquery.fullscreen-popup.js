    ...
    FSP = (function() {
      ...
      FSP.prototype.createWrappers = function() {
        ...
        this.contentWrapper = $("<div/>", {
          ...
          "style": "height: " + this.targetSizes.height + "px; margin:0 auto;"
        }).appendTo(this.mainWrapper);
        return this.close = $("<a/>", {
          href: "#",
          html: "",
          "class": "pe-7s-close " + this.options.closePopupClass,
          "style": this.options.inlineStyles ? "position: absolute; right: 50px; top: 25px; font-size:60px;" : void 0
        }).appendTo(this.mainWrapper);
      };
